...
from .views import SongListView, SongDetailView, SongStreamView, SongDownloadView, PlaylistListView, PlaylistDetailView, PlaylistAddSongView, PlaylistRemoveSongView
